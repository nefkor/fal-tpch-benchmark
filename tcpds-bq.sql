...
-- Gradient Systems
--
create table aol_gendata1000.dbgen_version
(
    dv_version                STRING                   ,
    dv_create_date            date                          ,
    dv_create_time            time                          ,
...
create table aol_gendata1000.customer_address
(
...
create table aol_gendata1000.customer_demographics
(
...
create table aol_gendata1000.date_dim
(
...
create table aol_gendata1000.warehouse
(
...
create table aol_gendata1000.ship_mode
(
...
create table aol_gendata1000.time_dim
(
...
create table aol_gendata1000.reason
(
...
create table aol_gendata1000.income_band
(
...
create table aol_gendata1000.item
(
...
create table aol_gendata1000.store
(
...
create table aol_gendata1000.call_center
(
...
create table aol_gendata1000.customer
(
...
create table aol_gendata1000.web_site
(
...
create table aol_gendata1000.store_returns
(
...
create table aol_gendata1000.household_demographics
(
...
create table aol_gendata1000.web_page
(
...
create table aol_gendata1000.promotion
(
...
create table aol_gendata1000.catalog_page
(
...
create table aol_gendata1000.inventory
(
...
create table aol_gendata1000.catalog_returns
(
...
create table aol_gendata1000.web_returns
(
...
create table aol_gendata1000.web_sales
(
...
create table aol_gendata1000.catalog_sales
(
...
create table aol_gendata1000.store_sales
(
